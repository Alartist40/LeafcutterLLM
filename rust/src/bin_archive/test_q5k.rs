...
fn main() {
    ...
    for name in &["blk.0.attn_q.weight", "blk.0.attn_output.weight", "blk.0.ffn_gate.weight"] {
        ...
        leafcutter::kernels::q5_k_gemm::q5_k_matmul(&input, &q5, &mut output, 1, shape[0], shape[1]);
